    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ArtMuseum.Data.ApplicationDbContext>
    {
        ...
        protected override void Seed(ArtMuseum.Data.ApplicationDbContext context)
        {
            ...
            context.Employees.AddOrUpdate(x => x.Id,
                new Employee() { Id = "A1234", OwnerId = Guid.NewGuid(), FirstName = "Sydney", LastName = "Vespa", Position = "Artist", MuseumId = 1 },
                new Employee() { Id = "B2345", OwnerId = Guid.NewGuid(), FirstName = "Michael", LastName = "Jolley", Position = "Curator", MuseumId = 2 },
                new Employee() { Id = "C3456", OwnerId = Guid.NewGuid(), FirstName = "Dylan", LastName = "Spangler", Position = "Clerk", MuseumId = 3 },
                new Employee() { Id = "D4567", OwnerId = Guid.NewGuid(), FirstName = "Pacita", LastName = "Abad", Position = "Artist", MuseumId = 4 },
                new Employee() { Id = "E5678", OwnerId = Guid.NewGuid(), FirstName = "Norman", LastName = "Adams", Position = "Curator", MuseumId = 5 },
                new Employee() { Id = "F6789", OwnerId = Guid.NewGuid(), FirstName = "Gaston", LastName = "Lachaise", Position = "Guard", MuseumId = 6 },
                new Employee() { Id = "G7890", OwnerId = Guid.NewGuid(), FirstName = "Anne", LastName = "Gaskell", Position = "Clerk", MuseumId = 7 },
                new Employee() { Id = "H8910", OwnerId = Guid.NewGuid(), FirstName = "Katsuhiro", LastName = "Yamaguchi", Position = "Guard", MuseumId = 8 }
                );
        }
    }
}
